...
public class ViewHistoryEntryFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
		...
		pedoValueSeries = new GraphViewSeries(new GraphViewData[] {
						new GraphViewData(MON, 2700d),
						new GraphViewData(TUE, 4050d),
						new GraphViewData(WED, 4000d),
						new GraphViewData(THU, 6000d),
						new GraphViewData(FRI, 3000d),
						new GraphViewData(SAT, 1050d),
